CREATE DATABASE IF NOT EXISTS ADM_PRE_SIT;
USE ADM_PRE_SIT;
...
UNIQUE KEY `index4` (`SolutionID`,`OpportunityScopeID`,`ToDate`)
)
ENGINE=INNODB;
...
#DROP TABLE IF EXISTS    
CREATE TABLE SolutionUtilPerYear
    (       
    SolutionUtilPerYearID    INT UNSIGNED NOT NULL AUTO_INCREMENT,
    SolutionID        INT UNSIGNED NOT NULL ,
    ...
    INDEX (SolutionUtilPerYearID),
    FOREIGN KEY (SolutionID) REFERENCES Solution(SolutionID) ON DELETE CASCADE,
    PRIMARY KEY(SolutionUtilPerYearID)
    )
ENGINE=INNODB;
...
CREATE TABLE `ProgramManagement` (
  ...
  CONSTRAINT `ProgramManagement_ibfk_1` FOREIGN KEY (`SolutionID`) REFERENCES `Solution` (`SolutionID`) ON DELETE CASCADE,
...
CREATE TABLE `ReleaseManagement` (
  ...
  KEY `SolutionID` (`SolutionID`),
  KEY `OpportunityScopeID` (`OpportunityScopeID`),
  CONSTRAINT `ReleaseManagement_ibfk_1` FOREIGN KEY (`SolutionID`) REFERENCES `Solution` (`SolutionID`) ON DELETE CASCADE,
...
CREATE TABLE `ChangeManagement` (
  ...
  KEY `SolutionID` (`SolutionID`),
  KEY `OpportunityScopeID` (`OpportunityScopeID`),
  CONSTRAINT `ChangeManagement_ibfk_1` FOREIGN KEY (`SolutionID`) REFERENCES `Solution` (`SolutionID`) ON DELETE CASCADE,
...
CREATE TABLE `CapacityManagement` (
  ...
  KEY `SolutionID` (`SolutionID`),
  KEY `OpportunityScopeID` (`OpportunityScopeID`),
  CONSTRAINT `CapacityManagement_ibfk_1` FOREIGN KEY (`SolutionID`) REFERENCES `Solution` (`SolutionID`) ON DELETE CASCADE,
...
CREATE TABLE `ConfigurationManagement` (
  ...
  KEY `SolutionID` (`SolutionID`),
  KEY `OpportunityScopeID` (`OpportunityScopeID`),
  CONSTRAINT `ConfigurationManagement_ibfk_1` FOREIGN KEY (`SolutionID`) REFERENCES `Solution` (`SolutionID`) ON DELETE CASCADE,
...
CREATE TABLE `SecurityManagement` (
  ...
  KEY `SolutionID` (`SolutionID`),
  KEY `OpportunityScopeID` (`OpportunityScopeID`),
  CONSTRAINT `SecurityManagement_ibfk_1` FOREIGN KEY (`SolutionID`) REFERENCES `Solution` (`SolutionID`) ON DELETE CASCADE,
...
CREATE TABLE `AvailabilityManagement` (
  ...
  KEY `SolutionID` (`SolutionID`),
  KEY `OpportunityScopeID` (`OpportunityScopeID`),
  CONSTRAINT `AvailabilityManagement_ibfk_1` FOREIGN KEY (`SolutionID`) REFERENCES `Solution` (`SolutionID`) ON DELETE CASCADE,
...
CREATE TABLE `DemandSupport` (
  ...
  KEY `SolutionID` (`SolutionID`),
  KEY `OpportunityScopeID` (`OpportunityScopeID`),
  CONSTRAINT `DemandSupport_ibfk_1` FOREIGN KEY (`SolutionID`) REFERENCES `Solution` (`SolutionID`) ON DELETE CASCADE,
...
CREATE TABLE `DesignBuild` (
  ...
  KEY `SolutionID` (`SolutionID`),
  KEY `OpportunityScopeID` (`OpportunityScopeID`),
  CONSTRAINT `DesignBuild_ibfk_1` FOREIGN KEY (`SolutionID`) REFERENCES `Solution` (`SolutionID`) ON DELETE CASCADE,
...
CREATE TABLE `DeploymentRollOut` (
  ...
  KEY `SolutionID` (`SolutionID`),
  KEY `OpportunityScopeID` (`OpportunityScopeID`),
  CONSTRAINT `DeploymentRollOut_ibfk_1` FOREIGN KEY (`SolutionID`) REFERENCES `Solution` (`SolutionID`) ON DELETE CASCADE,
...
CREATE TABLE `PostReleaseActivities` (
  ...
  KEY `SolutionID` (`SolutionID`),
  KEY `OpportunityScopeID` (`OpportunityScopeID`),
  CONSTRAINT `PostReleaseActivities_ibfk_1` FOREIGN KEY (`SolutionID`) REFERENCES `Solution` (`SolutionID`) ON DELETE CASCADE,
...
CREATE  TABLE `ProductEstimationForSolution` (
  ...
  `PerMonthEventCountInput` DECIMAL(10,2) NULL DEFAULT 0.00 ,
...
ENGINE = InnoDB;
  ...
  KEY `SolutionID` (`SolutionID`),
  KEY `OpportunityScopeID` (`OpportunityScopeID`),
  CONSTRAINT `E2EProcessQuality_ibfk_1` FOREIGN KEY (`SolutionID`) REFERENCES `Solution` (`SolutionID`) ON DELETE CASCADE,
...
CREATE TABLE `AccessManagement` (
  ...
  KEY `SolutionID` (`SolutionID`),
  KEY `OpportunityScopeID` (`OpportunityScopeID`),
  CONSTRAINT `AccessManagement_ibfk_1` FOREIGN KEY (`SolutionID`) REFERENCES `Solution` (`SolutionID`) ON DELETE CASCADE,
...
#DROP TABLE IF EXISTS ProductEstimationBaseEffortForSolution;
CREATE  TABLE `ProductEstimationBaseEffortForSolution` (
  `ProductEstimationBaseEffortForSolutionID` INT(10) NOT NULL AUTO_INCREMENT,
  `SolutionID` INT(10) UNSIGNED NOT NULL ,
  `OpportunityScopeID` INT(10) UNSIGNED NOT NULL ,
  `TotalBaseHours` FLOAT(10,2) NULL DEFAULT 0 ,
  `TotalBaseFTE` FLOAT(10,2) NULL DEFAULT 0 ,
  PRIMARY KEY (`ProductEstimationBaseEffortForSolutionID`) ,
  INDEX `fk_ProductEstimationBaseEffortForSolution_1` (`SolutionID` ASC) ,
  INDEX `fk_ProductEstimationBaseEffortForSolution_2` (`OpportunityScopeID` ASC) ,
  UNIQUE INDEX `index3` (`OpportunityScopeID` ASC, `SolutionID` ASC),
  CONSTRAINT `fk_ProductEstimationBaseEffortForSolution_1`
    FOREIGN KEY (`SolutionID` )
    REFERENCES `Solution` (`SolutionID` )
    ON DELETE CASCADE,
   CONSTRAINT `fk_ProductEstimationBaseEffortForSolution_2`
...
CREATE TABLE `ServiceAssurance` (
  ...
  KEY `SolutionID` (`SolutionID`),
  KEY `OpportunityScopeID` (`OpportunityScopeID`),
  CONSTRAINT `ServiceAssurance_ibfk_1` FOREIGN KEY (`SolutionID`) REFERENCES `Solution` (`SolutionID`) ON DELETE CASCADE,
 ...
 #DROP TABLE IF EXISTS OpportunityComponent   
CREATE TABLE OpportunityComponent
    (
    OpportunityComponentID    INT UNSIGNED NOT NULL AUTO_INCREMENT,
    OpportunityID    INT UNSIGNED NOT NULL,
    ComponentID    INT UNSIGNED NOT NULL,   
    INDEX (OpportunityComponentID),
    FOREIGN KEY (OpportunityID) REFERENCES Opportunity (OpportunityID),
...
#DROP TABLE IF EXISTS EffortDistribution;

#CREATE TABLE `EffortDistribution` (
#  `EffortDistributionID` int(10) unsigned NOT NULL AUTO_INCREMENT,
#  `OpportunityScopeID` int(10) unsigned NOT NULL,
#  `OpportunityComponentID` int(10) unsigned NOT NULL,
#  `ServiceElementID` int(10) unsigned NOT NULL,
#  `ForeignServiceElementID` int(10) unsigned DEFAULT NULL,
#  `Effort` FLOAT(10,2) unsigned DEFAULT NULL,
#  `CreatedBy` varchar(50) DEFAULT NULL,
#  `CreatedTimestamp` datetime DEFAULT NULL,
#  `UpdatedBy` varchar(50) DEFAULT NULL,
#  `UpdatedTimestamp` datetime DEFAULT NULL,
#  `ServiceFunctionFlag` enum('APP_DEV','APP_MAIN'),
#  PRIMARY KEY (`EffortDistributionID`),
#  KEY `OpportunityScopeID` (`OpportunityScopeID`),
#  KEY `OpportunityComponentID` (`OpportunityComponentID`),
#  KEY `ServiceElementID` (`ServiceElementID`),
#  CONSTRAINT `EffortDistribution_ibfk_1` FOREIGN KEY (`OpportunityScopeID`) REFERENCES `OpportunityScope` (`OpportunityScopeID`) ON DELETE CASCADE,
#  CONSTRAINT `EffortDistribution_ibfk_2` FOREIGN KEY (`OpportunityComponentID`) REFERENCES `OpportunityComponent` (`OpportunityComponentID`) ON DELETE CASCADE,
#  CONSTRAINT `EffortDistribution_ibfk_3` FOREIGN KEY (`ServiceElementID`) REFERENCES `ServiceElement` (`ServiceElementID`) ON DELETE CASCADE
#) ENGINE=InnoDB;



#DROP TABLE IF EXISTS AppMainSupportActivity;
CREATE TABLE `AppMainSupportActivity` (
  `AppMainSupportActivityID` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `OpportunityComponentID` int(10) unsigned NOT NULL,
  `CallVolume` varchar(50) DEFAULT NULL,
  `SupportWindowMatrixID` int(10) unsigned NOT NULL,
  `OnCallSupport` enum('Y','N'),
  `TicketsPerMonth` FLOAT(10,2) unsigned DEFAULT NULL,
  PRIMARY KEY (`AppMainSupportActivityID`),
  KEY `OpportunityComponentID` (`OpportunityComponentID`),
  KEY `SupportWindowMatrixID` (`SupportWindowMatrixID`),
  CONSTRAINT `AppMainSupportActivity_ibfk_2` FOREIGN KEY (`OpportunityComponentID`) REFERENCES `OpportunityComponent` (`OpportunityComponentID`) ON DELETE CASCADE,
  CONSTRAINT `AppMainSupportActivity_ibfk_3` FOREIGN KEY (`SupportWindowMatrixID`) REFERENCES `SupportWindowMatrix` (`SupportWindowMatrixID`) ON DELETE CASCADE
) ENGINE=InnoDB;


#DROP TABLE IF EXISTS TicketDistribution;
CREATE  TABLE `TicketDistribution` (
  ...
  UNIQUE INDEX `index4` (`OpportunityScopeID` ASC),
...
#DROP TABLE IF EXISTS AppMainSLA;
CREATE TABLE `AppMainSLA` (
  `AppMainSLAID` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `OpportunityID` int(10) unsigned NOT NULL,
  `OpportunityComponentID` int(10) unsigned NOT NULL,
  `Severity` varchar(50) DEFAULT NULL,
  `L1Response` FLOAT(10,2) unsigned DEFAULT NULL,
  `L2Response` FLOAT(10,2) unsigned DEFAULT NULL,
  `L3Response` FLOAT(10,2) unsigned DEFAULT NULL,
  `TicketDistribution` FLOAT(10,2) unsigned DEFAULT NULL,
  PRIMARY KEY (`AppMainSLAID`),
  KEY `OpportunityScopeID` (`OpportunityScopeID`),
  KEY `OpportunityComponentID` (`OpportunityComponentID`),
  CONSTRAINT `AppMainSLA_ibfk_1` FOREIGN KEY (`OpportunityScopeID`) REFERENCES `OpportunityScope` (`OpportunityScopeID`) ON DELETE CASCADE,
  CONSTRAINT `AppMainSLA_ibfk_2` FOREIGN KEY (`OpportunityComponentID`) REFERENCES `OpportunityComponent` (`OpportunityComponentID`) ON DELETE CASCADE
) ENGINE=InnoDB;
