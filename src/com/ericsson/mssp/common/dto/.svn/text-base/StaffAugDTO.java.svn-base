...
* File name       		    :  StaffAugTO.java
* Description				:	<To Do>
* Author, Date & Release	:	Dec 24, 20122012
* Modification history		:
* Number	|Date   	   |Author        |Remark
* -----------------------------------------------------------------------------------------------------
* 1      	| Dec 24, 2012  	   |eruvwyn   	  | Created.
* -----------------------------------------------------------------------------------------------------
**/
...
public class StaffAugDTO {
	...
	/**
	 * @return the staffingPlanId
	 */
	public Integer getStaffingPlanId() {
		return staffingPlanId;
	}
	/**
	 * @param staffingPlanId the staffingPlanId to set
	 */
	...
	/**
	 * @return the jobRoleName
	 */
	public String getJobRoleName() {
		return jobRoleName;
	}
	/**
	 * @param jobRoleName the jobRoleName to set
	 */
