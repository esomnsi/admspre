...
* All Rights Reserved
* Project         		    :  IT_MSSP
* Module				    :  com.ericsson.mssp.myactionapproval.dao
* File name       		    :  IInitiateApprovalProcessDAO.java
* Description				:	<To Do>
...
package com.ericsson.mssp.myactionapproval.dao;
 ...
 *
 */
public interface IInitiateApprovalProcessDAO {
